...
describe("ERC1155Proxy contract", function () {
  ...
  beforeEach(async function () {
    ...
    const ERC1155ProxyContract = await ethers.getContractFactory(
      "ERC1155Proxy"
    );
  ...
  it("mintBatchAddresses", async function () {
    await ERC1155Proxy.mintBatchAddresses(
  ...
  it("transferOwnership", async function () {
    ...
    await expect(
      ERC1155Proxy.transferOwnership(alice.address)
    ).to.be.revertedWith("ERC1155Proxy: Caller is not the owner");
  });
